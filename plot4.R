...
plot(x$DateTime, x$Global_active_power, type = "n", ylab = "Global Active Power (kilowatts)", xlab = " ")
lines(x$DateTime, x$Global_active_power)
plot(x$DateTime, x$Sub_metering_1, type = "n", ylab = "Energy sub mettering", xlab = " ")
...
plot(x$DateTime, x$Voltage, type = "n", ylab = "Voltage", xlab = "datetime")
lines(x$DateTime, x$Voltage)
plot(x$DateTime, x$Global_reactive_power, type = "n", ylab = "Global_reactive_power", xlab = "datetime")
